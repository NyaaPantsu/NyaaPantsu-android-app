...
interface TorrentApi {
    ...
    fun searchTorrentList(c: String?, q: String?, limit: String?, s: String?, toDate: String?, fromDate: String?, minSize: String?, maxSize: String?, sizeType: String?): Single<TorrentListResponse<TorrentModel>>
}